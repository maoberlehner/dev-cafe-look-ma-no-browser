...
export type ClickText<ReturnType> = (testId: TestId) => ReturnType;
...
export type AssertTextShouldExist<ReturnType> = (text: string) => ReturnType;
export type AssertTextShouldNotExist<ReturnType> = (text: string) => ReturnType;
